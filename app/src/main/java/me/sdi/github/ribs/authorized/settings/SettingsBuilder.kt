 ...
 */
class SettingsBuilder(dependency: ParentComponent) :
    ViewBuilder<SettingsView, SettingsRouter, SettingsBuilder.ParentComponent>(dependency) {
    ...
    override fun inflateView(inflater: LayoutInflater, parentViewGroup: ViewGroup): SettingsView? {
        return inflater.inflate(R.layout.settings_view, parentViewGroup, false) as SettingsView
    }
